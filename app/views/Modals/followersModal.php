  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" onclick="closeFollowersModal();" class="close" data-dismiss="modal" aria-label="Close">
...
<?php endif;?>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" onclick="closeFollowersModal();" data-dismiss="modal">Close</button>
